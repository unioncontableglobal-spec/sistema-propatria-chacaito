          ...
          {activeRole !== 'ASISTENTE' && (
            <div className="space-y-1">
              ...
              <ul className="space-y-1">
                ...
                <li><Link href="/expedientes" className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-colors ${pathname.startsWith('/expedientes') ? 'bg-[#1E293B] text-white font-medium' : 'text-gray-400 hover:text-white hover:bg-[#1E293B]'}`}><FolderOpen size={18} /> Gestión de Expedientes</Link></li>
